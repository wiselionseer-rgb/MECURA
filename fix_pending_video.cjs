            ...
            >
              ...
              <div className="absolute inset-0 z-0">
                <video 
                  ...
                  src="/2131.mov" 
                  className="w-full h-full object-cover opacity-[0.35] group-hover:opacity-50 transition-opacity duration-700 pointer-events-none"
                />
...
if (content.includes(target.replace(/\r\n/g, '\n'))) {
  ...
  console.log('patched pending video');
} else {
