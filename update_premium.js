        ...
        <section>
          ...
          <div className="grid grid-cols-4 gap-3">
            ...
            {pagamento_premium ? (
              ...
              <div /> // Placeholder to keep grid balanced if needed, or we just change the grid
            )}
          </div>
          ...
          {!pagamento_premium && (
            <motion.div
              ...
              whileTap={{ scale: 0.98 }}
              onClick={() => navigate('/premium-checkout')}
              className="mt-4 flex flex-col bg-gradient-to-br from-[#1A1A24] to-[#12121A] border border-[#A6FF00]/30 rounded-[28px] p-5 text-left group hover:border-[#A6FF00]/60 transition-all shadow-[0_8px_25px_rgba(166,255,0,0.15)] relative overflow-hidden outline-none cursor-pointer"
            >
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#A6FF00]/15 blur-[40px] rounded-full pointer-events-none" />
              <div className="absolute bottom-0 right-0 opacity-10 group-hover:opacity-20 transition-opacity duration-700">
                <Star className="w-32 h-32 text-[#A6FF00]" strokeWidth={0.5} />
              </div>
              
              <div className="flex items-start gap-4 relative z-10">
                <div className="w-14 h-14 rounded-[20px] bg-[#A6FF00]/10 border border-[#A6FF00]/20 flex items-center justify-center shrink-0">
                   <Star className="w-7 h-7 text-[#A6FF00]" strokeWidth={1.5} />
                </div>
                <div className="flex-1">
                   <div className="flex items-center justify-between mb-1.5">
                     <div className="flex items-center gap-1.5 bg-[#A6FF00]/10 px-2 py-0.5 rounded-full border border-[#A6FF00]/20">
...
if (content.includes("Categories Grid (Quick Services)")) {
