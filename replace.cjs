...
const content = fs.readFileSync('src/screens/DashboardScreen.tsx', 'utf-8');
...
const newReturn = `return (
    <div className="flex flex-col h-full bg-[#0A0A0F] text-mecura-pearl relative pb-20 font-sans overflow-y-auto overflow-x-hidden">
      ...
      >
        ...
        <section>
          {isConsultationFinished ? (
            ...
            >
              <div className="absolute top-0 right-0 w-64 h-64 bg-[#FF8A00]/15 blur-[80px] rounded-full pointer-events-none" />
              <div className="relative z-10 flex flex-col items-start">
                <div className="inline-flex items-center gap-2 bg-[#FF8A00]/10 border border-[#FF8A00]/20 px-3 py-1.5 rounded-full mb-6">
                  <div className="w-2 h-2 rounded-full bg-[#FF8A00] animate-pulse" />
                  <span className="text-[10px] font-bold text-[#FF8A00] uppercase tracking-widest">FILA DE ESPERA</span>
                </div>
          ...
          <div className="grid grid-cols-4 gap-3">
            ...
            {!pagamento_premium ? (
              <button 
                ...
                className="flex flex-col items-center gap-2.5 group outline-none"
              >
                <div className="w-full aspect-square rounded-[22px] bg-[#12121A] border border-[#D4AF37]/20 flex items-center justify-center group-hover:bg-[#1A1A24] group-hover:border-[#D4AF37]/40 transition-colors shadow-[0_4px_15px_rgba(0,0,0,0.2)] relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-br from-[#D4AF37]/10 to-transparent opacity-50 group-hover:opacity-100 transition-opacity" />
                  <Star className="w-6 h-6 text-[#D4AF37] relative z-10" />
                </div>
                <span className="text-[11px] text-[#D4AF37] font-medium transition-colors">Premium</span>
              </button>
            ) : (
              <button 
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {!pagamento_premium ? (
              <motion.button 
                ...
                whileTap={{ scale: 0.98 }}
                onClick={() => navigate('/premium-checkout')}
                className="flex flex-col bg-[#12121A] border border-[#D4AF37]/20 rounded-[28px] p-4 text-left group hover:bg-[#1A1A24] hover:border-[#D4AF37]/40 transition-all shadow-[0_4px_15px_rgba(0,0,0,0.4)] relative overflow-hidden outline-none"
              >
                <div className="absolute top-0 right-0 w-24 h-24 bg-[#D4AF37]/10 blur-[30px] rounded-full pointer-events-none" />
                <div className="w-full h-32 bg-gradient-to-br from-[#1A1A24] to-[#12121A] rounded-[20px] mb-4 flex flex-col items-center justify-center border border-[#D4AF37]/10 group-hover:border-[#D4AF37]/30 transition-colors overflow-hidden relative">
                  <ShieldCheck className="w-12 h-12 text-[#D4AF37] group-hover:scale-110 duration-500 relative z-10" strokeWidth={1} />
                  <div className="absolute bottom-3 flex -space-x-1.5 opacity-60">
                    ...
                    <div className="w-5 h-5 rounded-full bg-[#D4AF37]/20 border border-[#1A1A24] flex items-center justify-center text-[8px] font-bold text-[#D4AF37]">+</div>
                  </div>
                </div>
                <div className="flex items-center gap-1 mb-1">
                  <Star className="w-3 h-3 text-[#D4AF37] fill-[#D4AF37]" />
                  <span className="text-[9px] font-bold text-[#D4AF37] uppercase tracking-wider">Acesso VIP</span>
                </div>
              ...
              <motion.div 
                variants={itemVariants}
                className="flex flex-col bg-[#12121A] border border-[#D4AF37]/20 rounded-[28px] p-4 text-left shadow-[0_4px_15px_rgba(0,0,0,0.4)] relative overflow-hidden h-full"
              >
                <div className="absolute top-0 right-0 w-24 h-24 bg-[#D4AF37]/10 blur-[30px] rounded-full pointer-events-none" />
              ...
              >
                <div className="absolute top-0 right-0 w-24 h-24 bg-[#D4AF37]/10 blur-[30px] rounded-full pointer-events-none" />
                <div className="w-full h-32 bg-gradient-to-br from-[#1A1A24] to-[#12121A] rounded-[20px] mb-4 flex flex-col items-center justify-center border border-[#D4AF37]/10 group-hover:border-[#D4AF37]/30 transition-colors overflow-hidden relative">
                  <Calendar className="w-12 h-12 text-[#D4AF37] group-hover:scale-110 duration-500 relative z-10" strokeWidth={1} />
                </div>
                <div className="flex items-center gap-1 mb-1">
                  <Star className="w-3 h-3 text-[#D4AF37] fill-[#D4AF37]" />
                  <span className="text-[9px] font-bold text-[#D4AF37] uppercase tracking-wider">Acesso VIP</span>
      ...
      <div className="fixed top-0 left-0 w-full h-full pointer-events-none z-0 overflow-hidden">
        ...
        <div className="absolute bottom-[0%] right-[-20%] w-[60%] h-[60%] bg-[#D4AF37]/5 blur-[120px] rounded-full mix-blend-screen" />
      </div>
...
fs.writeFileSync('src/screens/DashboardScreen.tsx', beforeReturn + newReturn);
