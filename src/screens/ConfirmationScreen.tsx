  ...
  return (
    <div className="flex flex-col min-h-full bg-[#0A0A0F] text-mecura-pearl relative font-sans p-6 items-center justify-center">
      <div className="bg-[#1A1A24] rounded-3xl p-8 border border-[#2A2A3A] shadow-2xl text-center w-full max-w-md">
        <div className="w-20 h-20 bg-gradient-to-br from-[#A6FF00]/20 to-transparent rounded-full flex items-center justify-center mx-auto mb-6 border border-[#A6FF00]/30">
          <CheckCircle className="w-10 h-10 text-[#A6FF00]" />
        </div>

        <h2 className="text-3xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-[#A6FF00] to-[#C9FF5C]">
        ...
        <div className="bg-[#0A0A0F] rounded-2xl p-6 border border-[#2A2A3A] mb-8 text-sm text-mecura-silver text-left">
          <p className="mb-4">
            <strong className="text-[#A6FF00]">Fique atento:</strong> você receberá em breve a confirmação da consulta junto com o link de acesso à videochamada.
          </p>
          <p>
