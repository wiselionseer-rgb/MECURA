...
const regex = /<div className="text-\[#8A8A9E\] mb-2">Pacientes<\/div>\s*<div className="text-3xl font-bold text-white">\{patients\.length\}<\/div>\s*<\/div>\s*<\/div>\s*<\/div>\s*\)\}/;

const newStr = `<div className="text-[#8A8A9E] mb-2">Pacientes</div>
