...
const assocCategoryStr = code.substring(assocStart - 4, code.indexOf('];', assocStart) + 2); 
...
const newCatalog = `export const cbdGuideData: CBDCategory[] = [
  ...
  `; // I will append assocCategoryStr exactly as is.
...
const finalCode = filePrefix + newCatalog + assocCategoryStr + "\n\n" + enrichBlock;
